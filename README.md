...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/4IceG/luci-app-sms-manager?style=flat-square)
![GitHub stars](https://img.shields.io/github/stars/4IceG/luci-app-sms-manager?style=flat-square)
![GitHub forks](https://img.shields.io/github/forks/4IceG/luci-app-sms-manager?style=flat-square)
![GitHub All Releases](https://img.shields.io/github/downloads/4IceG/luci-app-sms-manager/total)
...
This is a development version of the package, so not everything may work....
>
> <img src="https://raw.githubusercontent.com/4IceG/Personal_data/master/dooffy_design_icons_EU_flags_Poland.png" height="24"> Pakiet w wersji rozwojowej, nie wszystko może działać...
...
![](https://github.com/4IceG/Personal_data/blob/master/zrzuty/sms-manager/Send%20Messages.png?raw=true)

> "USSD Codes" window / Okno kodów USSD:

![](https://github.com/4IceG/Personal_data/blob/master/zrzuty/sms-manager/USSD%20Codes.png?raw=true)
